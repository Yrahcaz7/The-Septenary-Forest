	...
	if (layer == "s") {
		if (name == "Glow") {
			return [
				...
				"resource-display",
				"blank",
				["display-text", 'you are generating <h2 class="layer-s">' + format(player.s.glow_gain) + '</h2> glow/sec, with a maximum of <h2 class="layer-s">' + format(player.s.glow_max) + '</h2> glow<br>you have <h2 class="layer-s">' + format(player.s.glow) + '</h2> glow, which multiplies sanctum gain and light gain after hardcap by <h2 class="layer-s">' + format(player.s.glow_effect) + '</h2>x'],
				"blank",
