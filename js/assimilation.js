...
function getAssimilationRewards() {
	...
	if (isAssimilated('sp')) {
		...
		if (colorValue[1] != 'none' && colorValue[0][0]) text += 'Makes you always be able to buy max subatomic particles<br>Increases the cap of <b class="layer-sp">Protons</b>, <b class="layer-sp">Neutrons</b>, and <b class="layer-sp">Electrons</b> by 90<br>Makes all previous subatomic particle upgrades always unlockable<br>Unlocks four new subatomic particle upgrades: <b class="layer-sp">Proton Decay</b>, <b class="layer-sp">Neutron Decay</b>, <b class="layer-sp">Electron Decay</b>, and <b class="layer-sp">Particle of the Flow</b>';
	...
	if (isAssimilated('ds')) {
		...
		if (colorValue[1] != 'none' && colorValue[0][0]) text += 'Increases the cap of <b class="layer-ds">Demonic Energy</b> by 77<br>Makes the <b class="layer-ds">Demonic Energy</b> cost formula worse<br>Changes the goals of the first four demon soul challenges<br>Makes all previous demon soul upgrades always unlockable<br>Unlocks two new demon soul upgrades: <b class="layer-ds">Demonic Hexes</b> and <b class="layer-ds">Wider Gate</b>';
	...
	if (isAssimilated('a')) {
		...
		if (colorValue[1] != 'none' && colorValue[0][0]) text += 'Unlocks the <b class="layer-a">Atomic Reactor</b>, a new tab<br>Removes all <b class="layer-a">Atomic Tree</b> limitations<br>Unlocks <b class="layer-mo">Synergism</b>, a new tab<br>Unlocks the first <b class="layer-mo">Synergy</b>';
