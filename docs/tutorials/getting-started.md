...
And now, you have successfully used Github! You can look at the next tutorial on [making a mod](making-a-mod.md), or look at the [documentation](/docs/!general-info.md) to see how The Modding Tree's system works and to make your mod a reality.
