...
Bars let you display information in a more direct way.
It can be a progress bar, health bar, capacity gauge, or anything else.
...
- `display()`: **optional**. A function that returns text to be displayed on top of the bar.
    (Can use basic HTML.)
...
- `instant`: **very optional**. If this is true, the bar will instantly snap to the current value instead of animating in between.
