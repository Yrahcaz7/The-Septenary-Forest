...
See the [`break_eternity.js` README](https://github.com/Patashu/break_eternity.js/blob/master/README.md) for more details on working with `Decimal` values, or [this list of `Decimal` functions](decimal-methods.md) if you want to go deep.
