...
addLayer("cb", {
	...
	effect() {
		...
		// effects
		let eff = (inChallenge("sp", 16) ? [newDecimalOne(), newDecimalOne(), newDecimalOne()] : [
	...
	componentStyles: {
		...
		clickable: {"min-height": "58px", border: "solid 4px #E5B55A", "border-radius": 0, color: "#DFDFDF", transform: "none"},
	},
	clickables: {
		11: {
		...
		12: {
			...
			effect() {
				if (inChallenge("sp", 16)) return newDecimalOne();
