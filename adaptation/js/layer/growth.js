...
addLayer("g", {
	...
	milestones: {
		0: {
			...
			effectDescription(eff) {return "multiply the base effect of WIS based on growth points<br>Effect: " + format(eff) + "x<br>Req: " + formatWhole(this.requirement) + " growth points"},
		...
		1: {
			...
			effectDescription(eff) {return "multiply the base effect of STR based on growth points<br>Effect: " + format(eff) + "x<br>Req: " + formatWhole(this.requirement) + " growth points"},
			done() {return player.g.points.gte(this.requirement)},
		...
		3: {
			...
			effectDescription() {
				...
				return "change the base effect of INT<br>Req: " + formatWhole(this.requirement) + " growth points";
			},
			done() {return player.g.points.gte(this.requirement)},
			unlocked() {return hasMilestone("g", this.id - 1) || player.e.unlocked},
		},
		...
		54: {
			...
			effectDescription(eff) {return "multiply the base effect of STR based on growth points<br>and increase its maximum by 90<br>Effect: " + format(eff) + "x<br>Req: " + formatWhole(this.requirement) + " growth points"},
			done() {return player.g.points.gte(this.requirement)},
			unlocked() {return hasMilestone("g", this.id - 1) || player.sp.unlocked},
		},
		55: {
		...
		56: {
			...
			effectDescription(eff) {return "multiply the base effect of WIS based on growth points<br>and increase its maximum by 90<br>Effect: " + format(eff) + "x<br>Req: " + formatWhole(this.requirement) + " growth points"},
			done() {return player.g.points.gte(this.requirement)},
			unlocked() {return hasMilestone("g", this.id - 1) || player.sp.unlocked},
		},
		57: {
		...
		61: {
			...
			effectDescription(eff) {return "multiply the base effect of STR based on growth points<br>and increase its maximum by 750<br>Effect: " + format(eff) + "x<br>Req: " + formatWhole(this.requirement) + " growth points"},
			done() {return player.g.points.gte(this.requirement)},
			unlocked() {return hasMilestone("g", this.id - 1) || player.sp.unlocked},
		},
		62: {
			...
			effectDescription(eff) {return "multiply the base effect of WIS based on growth points<br>and increase its maximum by 750<br>Effect: " + format(eff) + "x<br>Req: " + formatWhole(this.requirement) + " growth points"},
			done() {return player.g.points.gte(this.requirement)},
			unlocked() {return hasMilestone("g", this.id - 1) || player.sp.unlocked},
		},
		63: {
		...
		69: {
			...
			effectDescription(eff) {return "increase extra INT levels based on growth points<br>Effect: +" + formatWhole(eff) + "<br>Req: " + formatWhole(this.requirement) + " growth points"},
			done() {return player.g.points.gte(this.requirement)},
			unlocked() {return hasMilestone("g", this.id - 1) || player.cb.unlocked},
		},
		70: {
