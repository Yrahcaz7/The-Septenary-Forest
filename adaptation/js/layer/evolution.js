...
addLayer("e", {
	...
	effect() {
		let mult = [newDecimalOne(), newDecimalOne(), new Decimal(2), new Decimal(0.5), new Decimal(0.25), newDecimalOne()];
		// extra effects
