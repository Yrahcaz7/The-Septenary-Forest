...
const optionGrid = [
	[
		...
		{opt: "colorDisplayMode", text() {return "Color Text Mode: " + DISPLAY_MODES[options[this.opt]]}, onClick: displayMode},
	], [
		...
		{opt: "colorDisplay", text() {return "Colored Text: " + COLOR_DISPLAYS[options[this.opt]]}, onClick: colorDisplay},
	], [
